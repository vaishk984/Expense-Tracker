...
export const incomeColors = [
  '#123123', '#154731', '#165f40', '#16784f', '#14915f', 
  '#10ac6e', '#0bc77e', '#04e38d', '#00ff9d'
];

// Colors for expense categories
export const expenseColors = [
  '#b50d12', '#bf2f1f', '#c9452c', '#d3583a', '#dc6a48', 
  '#e57c58', '#ee8d68', '#f79d79', '#ffae8a', '#cc474b', '#f55b5f'
];

// Income categories with initial amount 0 and color assigned
...
// Expense categories with initial amount 0 and color assigned
...
// Utility function to reset amounts to zero
